...
setup_scripts = "npx hardhat run setup-scripts.js --network localhost"

setup_steps = [hh_compile, ERC721_deployment, ERC20_deployment, governance_deployment, setup_scripts]
